    ...
    public ResizeTest() {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                JFrame frame = new JFrame("WAL - Machine Simulator");
                frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                //frame.add(new TestPane());
                //frame.pack() sizes the frame so that all contents are at or above their prefered size
                frame.pack(); 
                //if argument is null, sets the frame in the center of the screen.
